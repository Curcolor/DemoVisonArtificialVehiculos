@echo off
REM Sistema de Detección y Seguimiento de Vehículos - Script principal
...
echo.
echo 1. Deteccion en tiempo real (camara)
echo 2. Deteccion en archivo de video
echo 3. Calibrar parametros
echo 4. Salir
echo.
